...
if(document.body.dataset.page === 'dashboard'){
  const els = {
    loginScreen: document.getElementById('loginScreen'), dashboardScreen: document.getElementById('dashboardScreen'),
    ...
    sidebarToggle: document.getElementById('sidebarToggle'), specialtyChart: document.getElementById('specialtyChart'),
